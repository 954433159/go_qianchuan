      ...
      <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border-l-4 border-blue-500 p-4 rounded-lg shadow-sm">
        <div className="flex items-start gap-3">
          ...
          <div className="flex-1">
            <h3 className="text-sm font-semibold text-blue-900">ℹ️ 功能说明</h3>
            <p className="mt-1 text-sm text-blue-800">
              账户级预算管理功能正在对接千川SDK中。当前请通过<strong>「广告组预算」</strong>和<strong>「广告计划预算」</strong>来管理投放成本。
            </p>
