...
// BatchCampaignStatusUpdateReq 广告组状态更新-请求
...
func (m *Manager) CampaignListGet(req CampaignListGetReq) (res *CampaignListGetRes, err error) {
	...
	if err != nil {
		return nil, fmt.Errorf("序列化Filter失败: %w", err)
	}
